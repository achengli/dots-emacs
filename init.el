...
(custom-set-variables
 ...
 '(package-selected-packages
   '(smooth-scrolling gnuplot company-maxima yasnippet maxima doom-modeline vala-mode ov latex-extra vterm which-key lsp-mode company timu-rouge-theme org-bullets julia-mode lua-mode ef-themes modus-themes evil)))
(custom-set-faces
